...
/// Writes logs to ~/Library/Logs/KeyScribe/ — no network calls.
enum CrashReporter {
    private static let logger = Logger(subsystem: "KeyScribe", category: "CrashReporter")
