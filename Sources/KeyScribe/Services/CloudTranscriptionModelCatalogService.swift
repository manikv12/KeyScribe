...
actor CloudTranscriptionModelCatalogService {
    ...
    private static let cachePrefix = "KeyScribe.cloudTranscriptionModelCatalogCache."
    ...
    private func requestTimeout(for provider: CloudTranscriptionProvider?) -> TimeInterval {
        ...
        let rawTimeout = defaults.object(forKey: "KeyScribe.cloudTranscriptionRequestTimeoutSeconds") == nil
            ? 30
            : defaults.double(forKey: "KeyScribe.cloudTranscriptionRequestTimeoutSeconds")
