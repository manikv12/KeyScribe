...
enum TextInserter {
    ...
    private static let keyScribeTransientMarkerType = NSPasteboard.PasteboardType("com.keyscribe.transient-marker")
    ...
    private static func debugLog(_ message: String) {
        ...
        let url = URL(fileURLWithPath: "/tmp/keyscribe-paste-debug.log")
    ...
    private static func writePasteboardItemWithMetadata(text: String, pasteboard: NSPasteboard) -> Bool {
        ...
        _ = item.setData(Data(), forType: keyScribeTransientMarkerType)
    ...
    private static func pasteboardContainsTransientMarker(_ pasteboard: NSPasteboard) -> Bool {
        ...
        for item in items {
            if item.availableType(from: [keyScribeTransientMarkerType]) != nil {
                return true
            }
        }
    ...
    private static func shouldTryDirectInsertForFrontmostApp() -> Bool {
        ...
        guard ProcessInfo.processInfo.environment["KEYSCRIBE_ENABLE_AX_DIRECT_INSERT"] == "1" else {
            return false
        }
