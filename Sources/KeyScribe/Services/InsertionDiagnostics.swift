...
enum InsertionDiagnostics {
    static let defaultsEnabledKey = "KeyScribe.insertionDiagnosticsEnabled"
    private static let envEnabledKey = "KEYSCRIBE_INSERTION_DIAGNOSTICS"
    private static let envLogPathKey = "KEYSCRIBE_INSERTION_DIAGNOSTICS_PATH"
    private static let defaultLogPath = "/tmp/keyscribe-insertion-diagnostics.log"
    private static let writeQueue = DispatchQueue(label: "KeyScribe.InsertionDiagnostics")
