        ...
        AssistantBetaWindowModel(
            ...
            banners: [
                ...
                AssistantBetaBanner(
                    ...
                    message: "If the helper is missing, KeyScribe can guide the user through install and sign-in.",
    ...
    static var previewListening: AssistantBetaOrbHUDModel {
        AssistantBetaOrbHUDModel(
            state: AssistantBetaOrbState(
                ...
                detail: "Speak normally. KeyScribe will put the draft in the assistant window.",
                audioLevel: 0.72
            )
        )
    }
