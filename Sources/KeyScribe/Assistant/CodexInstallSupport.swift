...
struct CodexInstallSupport {
    ...
    func inspect() async -> AssistantInstallGuidance {
        ...
        if resolvedCodex != nil {
            ...
            primaryDetail = "Codex App Server is available on this Mac. KeyScribe can sign in with ChatGPT, browse saved threads, and stream live assistant progress."
        } else {
            primaryTitle = "Install Codex"
            primaryDetail = "KeyScribe needs Codex before the assistant can run."
        }
