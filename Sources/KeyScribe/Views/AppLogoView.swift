...
/// Displays the KeyScribe app icon from the bundled PNG asset.
struct AppLogoView: View {
    ...
    private var logoImage: Image {
        for fileName in ["AppIcon", "AppLogo"] {
            ...
            // Also try the KeyScribe_KeyScribe bundle that SwiftPM may generate.
            if let resourceBundle = Bundle(identifier: "KeyScribe_KeyScribe"),
        ...
        for subpath in [
            "KeyScribe_KeyScribe.bundle/AppIcon.png",
            "KeyScribe_KeyScribe.bundle/AppLogo.png",
            "AppIcon.png",
            "AppLogo.png",
        ] {
