...
KeyScribe is designed for people who type all day and want speech input that actually fits real workflows.
...
KeyScribe can keep context per app and thread so rewrites stay coherent over longer sessions.
...
KeyScribe aims to feel lightweight while still giving power users advanced control.
