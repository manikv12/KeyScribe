...
final class AssistantMemorySuggestionServiceTests: XCTestCase {
    ...
    func testAcceptSuggestionPromotesAssistantOnlyMemory() throws {
        ...
        let scope = MemoryScopeContext(
            appName: "KeyScribe",
            bundleID: "com.keyscribe.app",
            surfaceLabel: "Assistant",
            projectName: "KeyScribe",
            repositoryName: "KeyScribe",
    ...
    func testAutomaticFailureSuggestionsSkipNormalCompletedAnswer() throws {
        ...
        let created = try suggestionService.createAutomaticFailureSuggestions(
            from: """
            Yes — I checked now. Your Obsidian vault has updates. As of March 8, 2026, the files changed in the last 24 hours were Project memories/AssistantPlanCopilot.md and Personal Projects/KeyScribe/07 - Documentation/KeyScribe - GitHub Snapshot (Latest).md.
            """,
            toolCount: 7,
            threadID: "thread-4",
            scope: scope
